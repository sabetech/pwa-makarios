...
import { Card, Space, Divider, Button, DotLoading, DatePicker, Tabs } from 'antd-mobile';
            ...
            <div className="profile-content">
                ...
                <div className="profile-tabs-container">
                    <Tabs activeKey={activeTab} onChange={setActiveTab} className="profile-tabs">
                        <Tabs.Tab title="Profile" key="profile">
                        ...
                        <Tabs.Tab title="Attendance" key="attendance">
                            <div className="profile-tab-content">
                                {attendanceData && (
